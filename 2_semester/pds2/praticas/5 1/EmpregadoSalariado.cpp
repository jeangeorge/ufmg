...
EmpregadoSalariado::EmpregadoSalariado(const string& primeiro, const string& ultimo, const string& cpf, 
  int mes, int dia, int ano, double salario) : Empregado(primeiro, ultimo, cpf, mes, dia, ano)
{
...
double EmpregadoSalariado::salario() const
{
