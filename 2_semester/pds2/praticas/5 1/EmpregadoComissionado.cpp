...
EmpregadoComissionado::EmpregadoComissionado(const string& primeiro, const string& ultimo, const string& cpf, 
  int mes, int dia, int ano, double vendas, double taxa) : Empregado(primeiro, ultimo, cpf, mes, dia, ano)
{
...
double EmpregadoComissionado::getTaxaComissao() const
{
  return taxaComissao;
}
...
double EmpregadoComissionado::getVendasBrutas() const
{
  return vendasBrutas;
}
...
void EmpregadoComissionado::imprime() const
{
  ...
  Empregado::imprime();
  cout << "\nvendas brutas: " << getVendasBrutas() << "; taxa comissao: " << getTaxaComissao();
}
